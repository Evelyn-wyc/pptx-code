...
- When the presentation library permits it, write both Latin and East Asian typeface settings into the PPTX. Use intentional line breaks and adequately sized text boxes so that small metric differences between font implementations do not change the hierarchy or create orphaned lines.
